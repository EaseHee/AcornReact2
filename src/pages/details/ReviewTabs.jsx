  ...
  return (
    <Tabs.Root mt={4} variant="line" defaultValue="stars">
      <Tabs.List style={{ display: 'flex', justifyContent: 'center', gap: '16px' }}>
        <Tabs.Trigger value="stars" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1.1rem' }}>
          <FaRegStar />
          별점 리뷰
        </Tabs.Trigger>
        <Tabs.Trigger value="comments" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1.1rem' }}>
          <FaRegCommentAlt />
          자유 댓글
        </Tabs.Trigger>
        <Tabs.Trigger value="blog" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1.1rem' }}>
          <RiBloggerLine />
          블로그 리뷰
        </Tabs.Trigger>
      </Tabs.List>
